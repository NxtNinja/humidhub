import { CloudSun, Code, Globe, Mail } from "lucide-react";
import Link from "next/link";
import { navigation } from "@/config/navigation";

export function Footer() {
  return (
    <footer className="w-full border-t border-border/40 bg-background pt-12 pb-8 mt-16">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-8 mb-12">
          ...
          <div className="col-span-1 md:col-span-2 flex flex-col gap-4">
            ...
            <p className="font-mono text-xs text-muted-foreground leading-relaxed max-w-sm">
              Modern weather intelligence and environmental telemetry. Providing
              hyper-local forecasts, air quality indices, and seismic activity
              monitoring.
            </p>
            <div className="flex items-center gap-4 mt-2">
              ...
              <a
                href="mailto:priyangsubanik@outlook.com"
                className="text-muted-foreground hover:text-foreground transition-colors"
              >
